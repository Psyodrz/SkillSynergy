          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-5xl md:text-6xl font-black text-charcoal-900 dark:text-white mb-6 leading-tight">
                Master Skills <br />
                <span className="text-blue-600 dark:text-blue-400">Faster, Together</span>
              </h1>
              <p className="text-xl text-charcoal-600 dark:text-mint-200 mb-8 leading-relaxed">
                Learning in isolation is hard. SkillSynergy pairs you with mentors and study partners so you can share resources, get feedback, and stay motivated.
              </p>
            ...
            <div className="relative">
              ...
              <div className="aspect-square rounded-3xl bg-gradient-to-tr from-blue-100 to-emerald-100 dark:from-charcoal-800 dark:to-charcoal-700 p-8 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-charcoal-500 dark:text-gray-400 font-medium">Peer-to-Peer Education</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-charcoal-800 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-charcoal-700">
              ...
              <h3 className="text-xl font-bold text-charcoal-900 dark:text-white mb-3">Find a Mentor</h3>
              <p className="text-charcoal-600 dark:text-gray-400">
                Connect with experienced professionals who can guide your career path, review your code, and offer industry insights.
              </p>
            </div>
            <div className="bg-white dark:bg-charcoal-800 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-charcoal-700">
              <TrendingUp className="w-10 h-10 text-emerald-500 mb-6" />
              <h3 className="text-xl font-bold text-charcoal-900 dark:text-white mb-3">Skill Exchange</h3>
              <p className="text-charcoal-600 dark:text-gray-400">
                Teach what you know, learn what you don't. Swap skills with others—e.g., teach Design in exchange for React lessons.
              </p>
            </div>
            <div className="bg-white dark:bg-charcoal-800 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-charcoal-700">
              <Award className="w-10 h-10 text-purple-500 mb-6" />
              <h3 className="text-xl font-bold text-charcoal-900 dark:text-white mb-3">Verified Growth</h3>
              <p className="text-charcoal-600 dark:text-gray-400">
