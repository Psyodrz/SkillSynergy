...
const ChatPage = () => {
  return (
    <div className="min-h-screen bg-mint-50 dark:bg-charcoal-950 flex flex-col">
      <Helmet>
        <title>Doubt Discussion - SkillSynergy</title>
        <meta name="description" content="Seamless doubt resolution for your study groups. Instant messaging and file sharing all in one place." />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-teal-100 dark:bg-teal-900/30 text-teal-700 dark:text-teal-300 font-semibold text-sm mb-6">
              ...
              <span>Seamless Doubt Resolution</span>
            </div>
            <h1 className="text-5xl md:text-7xl font-black text-charcoal-900 dark:text-white mb-8 leading-tight">
              Discuss Doubts. <br />
              <span className="text-teal-600 dark:text-teal-400">Learn Effortlessly.</span>
            </h1>
            <p className="text-xl text-charcoal-600 dark:text-mint-200 mb-10 max-w-2xl mx-auto">
              No need to switch between apps. SkillSynergy brings doubt discussion and resource sharing directly into your learning workspace.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-charcoal-800 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-charcoal-700 text-center">
              ...
              <h3 className="text-xl font-bold text-charcoal-900 dark:text-white mb-3">Instant Doubt Resolution</h3>
              <p className="text-charcoal-600 dark:text-gray-400">
                Real-time 1:1 and group discussions with message history synced across devices.
              </p>
            </div>
            <div className="bg-white dark:bg-charcoal-800 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-charcoal-700 text-center">
              ...
              <h3 className="text-xl font-bold text-charcoal-900 dark:text-white mb-3">Smart Study Groups</h3>
              <p className="text-charcoal-600 dark:text-gray-400">
                Share notes, links, and tasks in focused conversations to keep your learning moving.
              </p>
            </div>
            <div className="bg-white dark:bg-charcoal-800 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-charcoal-700 text-center">
